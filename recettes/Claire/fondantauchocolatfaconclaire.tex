% Fondant au chocolat (façon Claire T.)							% <-- x1
% \include{./recettes/Claire/fondantauchocolatfaconclaire}							% <-- x1
\section[\normalsize{Fondant au chocolat (fa\c con Claire T.)}]{\LARGE{\textsc{Fondant au chocolat (fa\c con Claire T.)}}}		% <-- x2
