%Biscuits de noël \`a la cannelle											% <-- x1
% \include{./recettes/Claire/biscuitsdenoelalacannelle}								% <-- x1
\section[\normalsize{Biscuits de noël \`a la cannelle}]{\LARGE{\textsc{Biscuits de noël \`a la cannelle}}}		% <-- x2
