%Brownies (façon Claire T.)											% <-- x1
% \include{./recettes/Claire/browniesfaconclaire}								% <-- x1
\section[\normalsize{Brownies (fa\c con Claire T.)}]{\LARGE{\textsc{Brownies (fa\c con Claire T.)}}}		% <-- x2
